"""Visualization for CKL-03-013: MIC pad via-check images.

Produces one PNG per MIC component showing pad outlines colour-coded by
...
def render_mic_via_image(comp, pkg, via_positions, is_bottom,
                         output_path: Path, *,
                         fid_resolved=None, signal_layer_name=None) -> Path:
    """Render a single MIC component's pads + vias to a PNG file.
    ...
    ax.set_title(
        ...
        f"CKL-03-013: VIA presence on MIC pads",
